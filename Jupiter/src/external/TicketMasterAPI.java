...
public class TicketMasterAPI {
	...
	private static final String API_KEY = "1EvXu0j5YlCMN3bp87wSt10fF09RDcSO";
	...
	public List<Item> search(double lat,double lon,String keyword){
		...
		try {
			...
			BufferedReader reader = new BufferedReader(new InputStreamReader(connection.getInputStream()));   // Second Time call API
			String line;
